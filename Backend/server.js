...
const allowedOrigins = [
  'http://65.2.34.70:9074',
  'http://65.2.34.70:9075',
  'http://65.2.34.70:9076',
  'http://65.2.34.70:9077',
  'http://65.2.34.70:3002',
  'http://127.0.0.1:5500',
  'http://127.0.0.1:5501',
  'http://127.0.0.1:5502',
  'http://localhost:8012',
  ...
  process.env.FRONTEND_URL || 'http://65.2.34.70:3002'
];
...
server.listen(PORT, '0.0.0.0', () => {
  logger.info(`Server running on http://65.2.34.70:${PORT}`);
  logger.info(`WebSocket server running on ws://65.2.34.70:${PORT}`);
